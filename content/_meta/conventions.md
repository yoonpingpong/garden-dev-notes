...
- [작성 흐름](#작성-흐름)
  - [리뷰는 초안 전체를 읽고 한 번에](#리뷰는-초안-전체를-읽고-한-번에)
- [컨벤션](#컨벤션)
- [문서 타입](#문서-타입)
- [공개 게이트](#공개-게이트)
- [ADR 인덱스](#adr-인덱스)
...
지적 사항을 한 건씩 주고받으면 쓰는 쪽이 문장 단위로만 고치게 되고, 절 전체가 어긋나는 것을 아무도 보지 못한다. 초안이 나오면 끝까지 읽은 뒤 지적을 목록으로 모아 전달한다. 그래야 구조 단위로 고칠 수 있다.
